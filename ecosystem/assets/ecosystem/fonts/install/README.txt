TMX Ecosystem fonts, installable set
====================================
...
Families (variable TTFs, install like any normal font):
  ...
  Fraunces-Italic-Variable.ttf  Fraunces Italic (brand setting: weight 500, optical size 72)
  JetBrainsMono-Variable.ttf    JetBrains Mono (weights 100-800; brand labels use 400/500)

The brand's Fraunces style is Medium Italic at optical size 72. There is no
static Medium cut of Fraunces, so use this variable font and set weight 500
plus optical size (opsz) 72 in your design tool. Never set Fraunces upright.
